 ...
 * @license MIT
 */
class extends t{constructor(e){super("input",e),this.addClass(t.CLASS_NAME.BUTTON);this.element.type="button"}getEditableNodeForValue(){return this.element}getEnabledElement(){return this.element}addListener(t){this.element.addEventListener("click",t,!1)}},SCanvas:e,SCheckBox:
/**
 * SCheckBox.js
 *
 * @module GuiBlocks
 ...
 * @author natade (https://github.com/natade-jp)
 * @license MIT
 */,SGroupBox:class extends t{constructor(e){super("fieldset"),this.addClass(t.CLASS_NAME.GROUPBOX),this.legend=document.createElement("legend"),t._addClass(this.legend,t.CLASS_NAME.GROUPBOX_LEGEND),this.legend.id=this.getId()+"_legend",this.legend.textContent=e,this.body=document.createElement("div"),t._addClass(this.body,t.CLASS_NAME.CONTENTSBOX),this.body.id=this.getId()+"_body";const i=this.element;i.appendChild(this.legend),i.appendChild(this.body)}getEnabledElement(){return this.element}getContainerElement(){return this.body}clear(){t._removeChildNodes(this.body)}}
/**
 * SImagePanel.js
 *
 * @module GuiBlocks
 ...
 * @author natade (https://github.com/natade-jp)
 * @license MIT
 */,SLabel:class extends t{constructor(e){super("div",e),this.addClass(t.CLASS_NAME.LABEL)}getContainerElement(){return this.element}}
/**
 * SPanel.js
 *
 * @module GuiBlocks
